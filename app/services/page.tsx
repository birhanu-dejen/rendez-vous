...
export default function Services() {
  return (
    <div className="max-w-6xl px-4 py-4 md:py-12 mx-auto md:px-16 bg-[#FAF6F0]">
      {/* Header */}
      <div className="space-y-4 text-center">
        <h1
          className={`${knewave.className} text-xl font-bold text-black opacity-100 md:text-4xl`}
        >
          RENDEZ-VOUS Hotel
        </h1>
        <p
          className={`${kalam.className}  mb-10 md:mb-20 max-w-6xl text-lg md:text-[32px] leading-normal tracking-normal text-black opacity-100 text-justify`}
        >
      ...
      {/* Sections with consistent vertical spacing on md */}
      <div className="space-y-20 md:space-y-40">
        {/* Rooms Section */}
        <div className="grid items-center grid-cols-2 gap-6 md:gap-8">
          <div>
            <h2
            ...
            <p
              className={`${kalam.className} text-base md:text-[32px] text-black opacity-100 text-justify`}
            >
        ...
        <div className="grid flex-row-reverse items-center grid-cols-2 gap-8">
          <Image
            ...
            width={500}
            height={300}
            className="rounded-lg h-100 md:h-85"
          />
          <div>
            <h2
              className={`${knewave.className} mb-2 text-xl md:text-4xl font-bold text-black text-center`}
            ...
            <p
              className={`${kalam.className} text-base md:text-[32px] leading-normal tracking-normal text-black opacity-100 text-justify`}
            >
              Sink in to our comfy sofas with a well-deserved drink and enjoy
              our Bar. Enjoy our superb wine list, premium beers and spirits
              from our menu, or arrange a bottle of champagne on ice for your
              arrival.
            </p>
          </div>
        </div>
